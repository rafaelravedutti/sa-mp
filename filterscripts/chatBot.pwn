...
//CONFIGURATION:
new BotName[30] = "Ladir"; 
new BotAge[20] = "14"; 
#define BotColour 0xFFD720FF 
...
#define AgeQuestion "Como Você Esta??" 

new Sayings[][] = { // The different sayings the bot says if a user types 'Botname' or 'Botname?'.
"Ladir È MARAAAAA!!!!?",
"ola, Vamos ao matagal??",
"Minha TESTOSTERONA ta a 1000!!!",
...
"Não",
"Talvez",
"Quem Você Pensa que Sou?Jesus?",
"Peça novamente mais tarde, estou Ocupado!"
};
...
"Servidor BRASIL È MARAA!!!",
"Para quem não em conhece Sou o Ladir personagem de ''Toma la, da ca!''",
"Ufa! Essa televisão... Nunca tem nada interessante para ver e eu acabei com as pilhas do controle remoto de tanto mudar de canal...",
"Quem ri por último, ri melhor.... Eu acho...",
"Você tem uma chave de fenda para me emprestar? Estou com um parafuso solto.",
"Perdi um parafuso em algum lugar. Por acaso você viu?"
};
...
public OnPlayerCommandText(playerid, cmdtext[])
{
	...
	if(strcmp(cmd, "/bot", true) == 0)
	{
		...
		if(botcmd==1)//Bot Name
		{
			...
			GetPlayerName(playerid, Name, sizeof(Name));
			format(Thing, sizeof(Thing), "%s Mudou o Nome do Bot de %s para %s", Name, BotName, tmp);
