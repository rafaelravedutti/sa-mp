...
enum enum_tData // Textdraw data.
{
	...
	T_Text[1024],           // The textdraw's string.
	Float:T_X,
	Float:T_Y,
	T_Alignment,
	T_BackColor,
...
public OnDialogResponse(playerid, dialogid, response, listitem, inputtext[])
{
    ...
    switch(dialogid)
    {
        ...
        case 6: // Delete project confirmation dialog
        {
            if(response)
            {
                new filename[128];
    ...
    ShowTextDrawDialog(playerid, 0);
       ...
       ShowTextDrawDialog(playerid, 0);
        ...
        case 9: // Change textdraw's position: exact or move
        {
            if(response)
            {
                switch(listitem)
        ...
        case 11: // Change textdraw's alignment
        {
            if(response)
            {
        ...
        case 12: // Change textdraw's proportionality
        {
            if(response)
            {
        ...
        case 14: // Textdraw's color: custom hex
        {
        	if(response)
            {
		...
		case 15: // Textdraw's color: Color combinator
        {
            if(response)
            {
        ...
        case 16: // Textdraw's color: premade colors
        {
            if(response)
            {
                new col;
        ...
        case 17: // Change textdraw's font
        {
            if(response)
            {
        ...
        case 18: // Change textdraw's letter size: exact or move
        {
            if(response)
            {
                switch(listitem)
        ...
        case 19: // Change letter size manually
        {
            if(response)
            {
            ...
            if(response)
            {
				switch(listitem)
				{
				    case 0: // Toggle outline
				    {
				        ...
				        else                                                        tData[pData[playerid][P_CurrentTextdraw]][T_Outline] = 2;
				        UpdateTextdraw(pData[playerid][P_CurrentTextdraw]);
        ...
        case 22: // outline shaow customized
        {
            if(response)
            {
      ...
      ShowTextDrawDialog(playerid, 5);
        ...
        case 26: // Export to self working filterscript
        {
            if(response)
            {
                switch(listitem)
		...
		case 27: // Write command for export
		{
		    if(response)
		    {
		...
		case 28: // Time after command for export
		{
		    if(response)
		    {
		...
		case 29: // Write time in secs to appear for export
		{
		    if(response)
		    {
		...
		case 30: // Time after appeared to dissapear for export
		{
		    if(response)
		    {
		...
		case 31: // Time after appeared to dissapear when kill for export
		{
		    if(response)
		    {
	...
	*/
	...
	switch(dialogid)
	{
	    case 0: // Select project.
	    {
		    ...
		    ShowPlayerDialog(playerid, dialogid, DIALOG_STYLE_LIST, CreateDialogTitle(playerid, "Startup"), info, "Accept", "Cancel");
		    return true;
	    }
	    ...
	    case 1:
	    {
	        ...
	        ShowPlayerDialog(playerid, dialogid, DIALOG_STYLE_INPUT, CreateDialogTitle(playerid, "New project"), info, "Accept", "Go back");
	        return true;
	    }
	    ...
	    case 2:
	    {
			...
			if(fexist("tdlist.lst"))
	        {
		        ...
		        ShowPlayerDialog(playerid, dialogid, DIALOG_STYLE_LIST, CreateDialogTitle(playerid, "Load project"), info, "Accept", "Go back");
		        fclose(tdlist);
	        }
	        else
	        {
			    ...
			    if(aux != 2)	ShowPlayerDialog(playerid, dialogid, DIALOG_STYLE_INPUT, CreateDialogTitle(playerid, "Load project"), info, "Accept", "Go back");
			    else            ShowPlayerDialog(playerid, dialogid, DIALOG_STYLE_INPUT, CreateDialogTitle(playerid, "Delete project"), info, "Accept", "Go back");
		    }
	        return true;
	    }
	    ...
	    case 3:
	    {
			ShowPlayerDialog(playerid, dialogid, DIALOG_STYLE_INPUT, CreateDialogTitle(playerid, "Load project"), \
	    ...
	    case 4: // Main edition menu (shows all the textdraws and lets you create a new one).
	    {
	        ...
	        ShowPlayerDialog(playerid, dialogid, DIALOG_STYLE_LIST, CreateDialogTitle(playerid, "Textdraw selection"), info, "Accept", "Cancel");
	        return true;
	    }
	    ...
	    case 5:
	    {
	        ...
	        ShowPlayerDialog(playerid, dialogid, DIALOG_STYLE_LIST, CreateDialogTitle(playerid, title), info, "Accept", "Cancel");
	        return true;
	    }
	    ...
	    case 6:
	    {
	        ...
	        ShowPlayerDialog(playerid, dialogid, DIALOG_STYLE_MSGBOX, CreateDialogTitle(playerid, "Confirm deletion"), info, "Yes", "No");
	        return true;
	    }
	    ...
	    case 8:
	    {
	        ...
	        ShowPlayerDialog(playerid, dialogid, DIALOG_STYLE_INPUT, CreateDialogTitle(playerid, "Textdraw's string"), info, "Accept", "Go back");
	        return true;
	    }
	    ...
	    case 9:
	    {
	        ...
	        ShowPlayerDialog(playerid, dialogid, DIALOG_STYLE_LIST, CreateDialogTitle(playerid, "Textdraw's position"), info, "Accept", "Go back");
	        return true;
	    }
	    ...
	    case 10:
	    {
	        ...
	        ShowPlayerDialog(playerid, dialogid, DIALOG_STYLE_INPUT, CreateDialogTitle(playerid, "Textdraw's position"), info, "Accept", "Go back");
	        return true;
	    }
	    ...
	    case 11:
	    {
	        new info[256];
	        info = "Left (type 1)\nCentered (type 2)\nRight (type 3)";
	        ShowPlayerDialog(playerid, dialogid, DIALOG_STYLE_LIST, CreateDialogTitle(playerid, "Textdraw's alignment"), info, "Accept", "Go back");
	        return true;
	    }
	    ...
	    case 12:
	    {
	        ...
	        ShowPlayerDialog(playerid, dialogid, DIALOG_STYLE_LIST, CreateDialogTitle(playerid, "Textdraw's proportionality"), info, "Accept", "Go back");
	        return true;
	    }
	    ...
	    case 13:
	    {
	        ...
	        ShowPlayerDialog(playerid, dialogid, DIALOG_STYLE_LIST, CreateDialogTitle(playerid, "Textdraw's color"), info, "Accept", "Go back");
	        return true;
	    }
	    ...
	    case 14:
	    {
	        ...
	        ShowPlayerDialog(playerid, dialogid, DIALOG_STYLE_INPUT, CreateDialogTitle(playerid, "Textdraw's color"), info, "Accept", "Go back");
	        return true;
	    }
	    ...
	    case 17:
	    {
	        new info[256];
	        info = "Font type 0\nFont type 1\nFont type 2\nFont type 3";
	        ShowPlayerDialog(playerid, dialogid, DIALOG_STYLE_LIST, CreateDialogTitle(playerid, "Textdraw's font"), info, "Accept", "Go back");
	        return true;
	    }
	    ...
	    case 18:
	    {
	        ...
	        ShowPlayerDialog(playerid, dialogid, DIALOG_STYLE_LIST, CreateDialogTitle(playerid, "Textdraw's font size"), info, "Accept", "Go back");
	        return true;
	    }
	    ...
	    case 19:
	    {
        	...
        	pData[playerid][P_Aux] = aux; // To know if he's editing X or Y.
	        ShowPlayerDialog(playerid, dialogid, DIALOG_STYLE_INPUT, CreateDialogTitle(playerid, "Textdraw's size"), info, "Accept", "Go back");
	        return true;
	    }
	    ...
	    case 20:
	    {
	        ...
	        ShowPlayerDialog(playerid, dialogid, DIALOG_STYLE_LIST, CreateDialogTitle(playerid, "Textdraw's outline"), info, "Accept", "Go back");
	        return true;
	    }
	    ...
	    case 21:
	    {
	        ...
	        ShowPlayerDialog(playerid, dialogid, DIALOG_STYLE_LIST, CreateDialogTitle(playerid, "Textdraw's outline shadow"), info, "Accept", "Go back");
	        return true;
	    }
	    ...
	    case 22:
	    {
	        ...
	        ShowPlayerDialog(playerid, dialogid, DIALOG_STYLE_INPUT, CreateDialogTitle(playerid, "Textdraw's outline shadow"), info, "Accept", "Go back");
	        return true;
	    }
	    ...
	    case 23:
	    {
	        new info[256];
	        info = "Box On\nBox Off";
	        ShowPlayerDialog(playerid, dialogid, DIALOG_STYLE_LIST, CreateDialogTitle(playerid, "Textdraw's box"), info, "Accept", "Go back");
	        return true;
	    }
	    ...
	    case 25:
	    {
	        ...
	        ShowPlayerDialog(playerid, dialogid, DIALOG_STYLE_LIST, CreateDialogTitle(playerid, "Textdraw's export"), info, "Accept", "Go back");
	        return true;
	    }
	    ...
	    case 27:
	    {
	        ...
	        ShowPlayerDialog(playerid, dialogid, DIALOG_STYLE_INPUT, CreateDialogTitle(playerid, "Textdraw's export"), info, "Accept", "Go back");
	        return true;
	    }
