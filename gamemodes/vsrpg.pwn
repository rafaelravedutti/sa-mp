...
#define COMMAND_REPORT_FILE_PATH     	"Virtual Society RPG/Log/Commands.ini"
#define CALLBACK_REPORT_FILE_PATH     	"Virtual Society RPG/Log/Callbacks.ini"
...
#define COLOUR_LIGHT_ORANGE             0xFFBB37AA
...
#define COLOUR_CABBIE           		0xFCFF11AA
...
#define REPORT_COMMAND                  5
#define REPORT_CALLBACK                 6
#define REPORT_UCP                      7
...
#define COLOUR_REPORT_COMMAND           COLOUR_PINK
...
//Quantidades máximas
#define MAX_COMPANIES_PER_PLAYER        1
...
//Reports
#define REPORT_MONEY                    0
#define REPORT_WEAPONS                  1
#define REPORT_HEALTH                   2
#define REPORT_MAX                      3
...
//Horário
#define JOBTIME(%1,%2)     				(((%1 & 0xFFFF) << 16) | (%2 & 0xFFFF))
#define JOBSTART(%1)          			((%1 >> 16) & 0xFFFF)
#define JOBEND(%1)            			(%1 & 0xFFFF)
...
new Explosives[][explosiveInfo] = {
    {"Bomba-Relogio",    			1500,   	1},
	{"Bomba c/ sensor aprox.",     	2000,  		1},
	{"Bomba Remota",     			1500,   	1},
	{"Bomba de gas",                200,        2},
	{"Flash",           			200,    	2},
	{"Rojao",           			200,    	2}
...
new Counters[][counterInfo] = {
	...
	{"TaxCounter",      INCREASER_COUNTER,      200}
};
...
new Weapons[][weaponInfo] = {
	...
	{"Pistola 9mm",							300,		30,			90,			346,			WEAPONSKILL_PISTOL,				2},
	{"Pistola 9mm c/ silenciador",			300,		30,			90,			347,			WEAPONSKILL_PISTOL_SILENCED,	2},
	{"Desert Eagle",						600,		12,			60,			348,			WEAPONSKILL_DESERT_EAGLE,		2},
	{"Escopeta Calibre 12",					1000,		10,			30,			349,			WEAPONSKILL_SHOTGUN,			3},
	{"Escopeta de Cano Serrado",			1250,		16,			64,			350,			WEAPONSKILL_SAWNOFF_SHOTGUN,	3},
	{"Escopeta de Combate",					1500,		15,			60,			351,			WEAPONSKILL_SPAS12_SHOTGUN,		3},
	{"Micro Uzi",							700,		50,			350,		352,			WEAPONSKILL_MICRO_UZI,			4},
	{"MP5",									1000,		60,			360,		353,			WEAPONSKILL_MP5,				4},
	{"AK47",								1200,		30,			300,		355,			WEAPONSKILL_AK47,				5},
	{"M4",									1200,		30,			300,		356,			WEAPONSKILL_M4,					5},
	{"TEC-9",								700,		50,			350,		372,			WEAPONSKILL_MICRO_UZI,			4},
	{"Country Rifle",						2000,		10,			30,			357,			WEAPONSKILL_SNIPERRIFLE,		6},
	{"Sniper Rifle",                        1800,		10,			30,			358,			-1,								6},
...
new ChickensFlavor[][foodInfo] = {
    {"Frango ao molho",        	25,		8.0},
    {"Frango a milanesa",       35,		11.0},
	{"Sanduiche de frango",     20,		5.0},
	{"Espetinho de frango",     15,		2.5},
	{"Salada",               	30,		9.0}
};
...
/*
	{"/correr [1-4]",       "PED",				"sprint_panic",				true},
...
new Jobs[][jobInfo] = {
    {NULL},
	{"Desempregado",			0,			COLOUR_UNEMPLOYED,				0,		0,	0,	0,		JOBTIME(0, 0),		{0}},
	{"Pescador",   				500,    	COLOUR_FISHER, 					0,		0,	0,	0,		JOBTIME(6, 18),		{0}},
	{"Taxista",         		600,    	COLOUR_CABBIE,          		0,		1,	0,	0,		JOBTIME(6, 18),		{0}},
	{"Barman",          		500,    	COLOUR_BARMAN,           		0,		0,	0,	0,		JOBTIME(8, 22),		{171, 189}},
	{"Pizzaboy",            	600,    	COLOUR_PIZZABOY,         		0,		1,	0,	0,		JOBTIME(9, 22),		{155, 209}},
	{"Maquinista",   			600,    	COLOUR_MACHINIST, 				0,		1,	0,	0,		JOBTIME(6, 20),		{0}},
	{"Lixeiro",                 700,        COLOUR_GARBAGE,                 10,     1,  0,  0,      JOBTIME(7, 20),		{16}},
	{"Agricultor",   			700,    	COLOUR_FARMER, 					10,		0,	0,	0,		JOBTIME(6, 18),		{157, 158, 159, 161}},
	{"Caminhoneiro",            100,        COLOUR_TRUCKER,            		20,		1,	0,	0,		JOBTIME(6, 22),		{0}},
	{"Jornalista",              1200,    	COLOUR_JOURNALIST,             	20,		1,	0,	1,		JOBTIME(6, 22),		{0}},
	{"Piloto",    				1200,    	COLOUR_PILOT, 					30,		0,	0,	1,		JOBTIME(8, 19),		{61}},
	{"Contrabandista",    		1500,    	COLOUR_SMUGGLER, 				30,		1,	0,	0,		JOBTIME(6, 22),		{111, 112}},
	{"Mecanico",                1200,    	COLOUR_MECHANIC,             	40,		1,	0,	0,		JOBTIME(6, 22),		{50,  268}},
	{"Paramedico",      		1000,    	COLOUR_PARAMEDIC,       		40,		1,	0,	0,		JOBTIME(6, 22),		{274, 275, 276}},
	{"Segurança",               1500,    	COLOUR_SECURITY,             	40,		0,	0,	0,		JOBTIME(2, 23),		{163, 164, 165, 166}},
	{"Motorista Particular",    1500,    	COLOUR_DRIVER,       			40,		1,	0,	0,		JOBTIME(6, 22),		{255}},
	{"Vendedor de Armas",    	1000,    	COLOUR_ARM_DEALER, 				50,		0,	0,	0,		JOBTIME(8, 18),		{179}},
	{"Policial Militar",    	1000,    	COLOUR_POLICE, 					50,		1,	0,	0,		JOBTIME(2, 22),		{280, 281, 282}},
	{"Advogado",                1000,	    COLOUR_LAWYER,                  60,		0,	0,	0,		JOBTIME(8, 18),		{0}},
	{"Traficante",          	1000,   	COLOUR_DRUG_DEALER,       		70,		0,	0,	0,		JOBTIME(2, 23),		{28,  29,  30}},
	{"Policial SWAT",       	1500,   	COLOUR_SWAT,    				70,		1,	0,	1,		JOBTIME(0, 23),		{285}},
	{"Delegado",            	3000,   	COLOUR_DELEGATE,         		100,	1,	0,	1,		JOBTIME(0, 23),		{125, 126}},
	{"Juiz",                    4000,   	COLOUR_JUDGE,                 	100,	0,	0,	0,		JOBTIME(8, 18),		{187}}
};
...
//Comandos
	...
	{"/iscas [quantidade de iscas]", 								"Para pegar iscas (Você deve estar no ícone aonde pega profissão).",  	{JOB_FISHER}},
...
new Companies[][companyInfo] = {
	{NULL},
	{"Cooperativa de Pesca",            "Tá Nervoso? Venha Pescar!",  	"Fish",				75000,         	JOB_FISHER,               	446.8782,    	-1875.5230,    	4.3722,		9},
...
new pReport[MAX_SLOTS][REPORT_MAX];
...
stock report(const string[], report_type = REPORT_DEFAULT)
{
	...
	else if(report_type == REPORT_COMMAND)
	{
	    logcreate("Command's", COMMAND_REPORT_FILE_PATH);
	    log = fopen(COMMAND_REPORT_FILE_PATH, io_append);
	    fwrite(log, time);
	    fwrite(log, string);
	    fwrite(log, "\r\n");
	    fclose(log);
	    
	    format(msg, sizeof msg, "[COMMAND REPORT]-> %s", string);
	    colour = COLOUR_REPORT_COMMAND;
	}
	
	else if(report_type == REPORT_CALLBACK)
	{
	    return;
	}
	...
	{
	    logcreate("Callback's", CALLBACK_REPORT_FILE_PATH);
	    log = fopen(CALLBACK_REPORT_FILE_PATH, io_append);
	    fwrite(log, time);
	   	fwrite(log, string);
	   	fwrite(log, "\r\n");
	   	fclose(log);
...
stock GetPlayerStateName(stateid)
{
	new statename[32];

	statename = (stateid == PLAYER_STATE_NONE) ? ("PLAYER_STATE_NONE") :
	            (stateid == PLAYER_STATE_ONFOOT) ? ("PLAYER_STATE_ONFOOT") :
	            (stateid == PLAYER_STATE_DRIVER) ? ("PLAYER_STATE_DRIVER") :
	            (stateid == PLAYER_STATE_PASSENGER) ? ("PLAYER_STATE_PASSENGER") :
	            (stateid == PLAYER_STATE_WASTED) ? ("PLAYER_STATE_WASTED") :
	            (stateid == PLAYER_STATE_SPAWNED) ? ("PLAYER_STATE_SPAWNED") :
	            (stateid == PLAYER_STATE_SPECTATING) ? ("PLAYER_STATE_SPECTATING") :
...
stock ChangePlayerJob(playerid, jobid)
{
	if(jobid > 0 && jobid < sizeof Jobs)
	{
        ...
        SetJobVehiclesParamsForPlayer(REEFER, 		playerid, 	admin || jobid == JOB_FISHER);
...
stock CashTaxes(playerid)
{
	new xpath[128], vhpath[128], string[128], name[MAX_PLAYER_NAME];
	new iptu, ipva, incometax, total, bank;
	
	xpath = GetPlayerXFilePath(playerid);
	bank = hGetInt(xpath, "Bank");
	iptu = ipva = incometax = 0;
	GetPlayerName(playerid, name, sizeof name);
	...
	for(new v = MaxServerVeh; v < GetVehicles(); v++)
	{
		...
		if(strlen(vhpath) > 0 && hGetInt(vhpath, "Deleted") == 0 && strcmp(name, hGetString(vhpath, "Owner"), true) == 0)
		    ipva += (Vehicles[GetVehicleModel(v) - 400][vehValue] * 4) / 100;
	}
	...
	for(new h = 0; h < GetHouses(); h++)
	{
		...
		if(strlen(vhpath) > 0 && hGetInt(vhpath, "Deleted") == 0 && strcmp(name, hGetString(vhpath, "Owner"), true) == 0)
		    iptu += hGetInt(vhpath, "Value") / 20;
	}
				
	total = iptu + ipva + incometax;
	...
	hSetInt(xpath, "Bank", bank);
	SendClientMessage(playerid, COLOUR_WHITE, "[------------------------------- Cobrança de Impostos -------------------------------]");
	format(string, sizeof string, "IPVA: $%d,00 dólares <> IPTU: $%d,00 dólares <> Imposto de Renda: $%d,00 dólares", ipva, iptu, incometax);
	SendClientMessage(playerid, COLOUR_GREEN, string);
	format(string, sizeof string, "Total: $%d,00 dólares <> Saldo atual: $%d,00 dólares", total, bank);
	SendClientMessage(playerid, COLOUR_GREEN, string);
...
{
	new vpath[128], name[MAX_PLAYER_NAME];
	new counter;
    ...
    for(new v = MaxServerVeh; v < GetVehicles(); v++)
	{
		...
		if(strlen(vpath) > 0 && hGetInt(vpath, "Deleted") == 0 && strcmp(name, hGetString(vpath, "Owner"), true) == 0)
			counter++;
	}
...
stock GetPlateServerVehicleId(const plate[])
{
	new v;
	
	if(strcmp(plate, "VSR ", true) != 0)
	    return INVALID_VEHICLE_ID;
	    
	if(IsNumeric(plate[4]))
	{
	    v = strval(plate[4]) - 1000;
	    
		if(v > -1 && v < MaxServerVeh)
		    return v;
...
stock GetPlatePlayerVehicleId(const plate[])
{
	...
	for(new v = MaxServerVeh; v < GetVehicles(); v++)
	{
	    ...
	    if(strlen(vplate) > 0 && hGetInt(vpath, "Deleted") == 0 && strcmp(vplate, plate, true) == 0)
	        return v;
	}
...
stock GetPlateVehicleId(const plate[])
{
	...
	return ((v = GetPlateServerVehicleId(plate)) != INVALID_VEHICLE_ID) ? v : GetPlatePlayerVehicleId(plate);
}
...
stock Pay(playerid, amount)
{
	...
	if(CurrentDay == 0 || CurrentHour < JOBSTART(Jobs[jobid][jobTime]) || CurrentHour > JOBEND(Jobs[jobid][jobTime]))
		SendClientMessage(playerid, COLOUR_GRAY, "Você não recebeu Xpoint pois não está no seu horário de trabalho.");
	    
	else if(GetPlayerCounter(playerid, COUNTER_LEVEL) <= 0)
	{
	    SetPlayerCounter(playerid, COUNTER_LEVEL, 15);
	    
	    hSetInt(xpath, "Xpoints", hGetInt(xpath, "Xpoints") + 1);
	    format(info, sizeof info, "~y~+Xpoint ~n~");
    	...
    	if(strlen(cpath) > 0 && reward > 0)
		{
			GivePlayerSysMoney(playerid, reward);
			hSetInt(cpath, "Balance", hGetInt(cpath, "Balance") - reward);
    ...
    if(strlen(info) > 0)
    {
		...
		if(tdinfo != Text:INVALID_TEXT_DRAW)
		{
...
stock UpdatePlayerSpawn(playerid)
{
	...
	if(GetPlayerCounter(playerid, COUNTER_JOB) > 60)
	    SetPlayerCounter(playerid, COUNTER_JOB, 60);
...
stock BanAcc(playerid, const reason[])
{
	...
	for(new n = 0; n < MAX_SLOTS; n++)
	{
	    if(IsPlayerConnected(n) && n != playerid)
	    {
	        new nIP[128];
	        
	        GetPlayerIp(n, nIP, sizeof nIP);
	        
	        if(strcmp(IP, nIP, true) == 0)
	            Kick(n);
	    }
	}
...
stock CheckBan(const playername[], const ip[])
{
	...
	while(fread(fp, tmp, sizeof tmp))
	{
	    ...
	    if(	(strlen(playername) > 0 && strlen(uname) > 0 && strcmp(uname, playername, true) == 0) ||
			(strlen(ip) > 0 && strlen(uIP) > 0 && strcmp(uIP, ip, true) == 0))
	    {
	        fclose(fp);
	        return 0;
	    }
...
stock GetPlayerCompanies(playerid)
{
	new cpath[128], owner[128], name[MAX_PLAYER_NAME];
	new counter;
    ...
    for(new c = 1; c < sizeof Companies; c++)
	{
		...
		if(strlen(cpath) > 0)
		{
		    owner = hGetString(cpath, "Owner");
	 		...
	 		if(strlen(owner) > 0 && strcmp(name, owner, true) == 0)
				counter++;
		}
	}
...
stock GetCompanyResult(id, &result)
{
	...
	{
	    result += (balance / 8) * random(3);
	    
		if(random(2) == 0)
  			result += (investment / 8) / (random(3) + 1) * (random(3) + 1);
  			
		else
		    result -= (investment / 8) / (random(4) + 2);
	}
...
public OnGameModeInit()
{
	...
	SendRconCommand("hostname [BR] Virtual Society Server");
	...
	//Pesca
	REEFER[0] = AddStaticServerVehicle(453, 424.1340, -1915.3978, -0.2800, 186.5213, 1, 1, 1500);
	REEFER[1] = AddStaticServerVehicle(453, 440.1670, -1915.0513, -0.5050, 191.0546, 1, 1, 1500);
	REEFER[2] = AddStaticServerVehicle(453, 452.9862, -1912.6359, -0.0007, 186.8377, 1, 1, 1500);
	REEFER[3] = AddStaticServerVehicle(453, 445.1464, -1940.0279, -0.5067, 180.6112, 1, 1, 1500);
	REEFER[4] = AddStaticServerVehicle(453, 421.1085, -1950.6237, -0.0823, 169.4422, 1, 1, 1500);
	REEFER[5] = AddStaticServerVehicle(453, 466.8812, -1937.8427, -0.5617, 193.3776, 1, 1, 1500);
	REEFER[6] = AddStaticServerVehicle(453, 407.7085, -1914.4837, -0.4268, 179.7381, 1, 1, 1500);
	REEFER[7] = AddStaticServerVehicle(453, 397.9501, -1947.5592, -0.4216, 159.7881, 1, 1, 1500);
...
public OnPlayerConnect(playerid)
{
	...
	for(new r = 0; r < REPORT_MAX; r++)
	    pReport[playerid][r] = 0;
	...
	if(IsPlayerLogged(playerid))
	{
	    if(Taximeter[playerid] != -1)
		{
		    ...
		    if(GetPlayerState(playerid) == PLAYER_STATE_DRIVER)
		    {
				...
				if(Taximeter[playerid] > 30)
					Pay(playerid, Taximeter[playerid] + 100);
		    ...
		    else
		    {
		        ...
		        if(Taximeter[playa] > 30)
					Pay(playa, Taximeter[playa] + 100);
...
{
    reportf("%s requisitou spawn", REPORT_CALLBACK, PlayerName(playerid));
...
{
    reportf("%s spawnou", REPORT_CALLBACK, PlayerName(playerid));
...
{
    reportf("%s mudou de interior %d -> %d", REPORT_CALLBACK, PlayerName(playerid), oldinteriorid, newinteriorid);
...
public ShowBalance(playerid)
{
    new xpath[128], string[128];

    xpath = GetPlayerXFilePath(playerid);
    format(string, sizeof string, "[ Saldo atual: $%d,00 dólares ]", hGetInt(xpath, "Bank"));
	SendPhoneMessage(PlayerName(playerid), "Virtual Bank", string);
}

public OnPlayerEnterCheckpoint(playerid)
{
    reportf("%s entrou em um checkpoint (Status: %d)", REPORT_CALLBACK, PlayerName(playerid), CheckpointStatus[playerid]);
...
{
    reportf("%s entrou em um checkpoint de corrida", REPORT_CALLBACK, PlayerName(playerid));
	...
	if(Transport[playerid] != 0)
	{
        ...
        if(dest)
        {
			...
			D = 1000.0 - D;
            value += MetersTraveled[playerid] / 20;
            value -= floatround(D);
            value -= value % 10;
...
public OnPlayerSelectedMenuRow(playerid, row)
{
    ...
    reportf("%s selecionou o item %d do menu %d", REPORT_CALLBACK, PlayerName(playerid), row, _:mid);
	...
	if(mid == Guns[8])
	{
		...
		else
		{
			...
			SetPlayerSysArmour(playerid, 100.0);
...
stock GivePlayerFood(playerid, const message[], value, Float:health, Menu:menu)
{
	...
	else
	{
		...
		hSetInt(GetPlayerXFilePath(playerid), "Hunger", 0);
		GivePlayerSysMoney(playerid, -value);
...
public OnPlayerExitedMenu(playerid)
{
	...
	mid = GetPlayerMenu(playerid);
    reportf("%s saiu do menu %d", REPORT_CALLBACK, PlayerName(playerid), _:mid);
...
public OnPlayerDeath(playerid, killerid, reason)
{
	if(killerid != INVALID_PLAYER_ID)
		reportf("%s foi morto por %s (Razão: %d)", REPORT_CALLBACK, PlayerName(playerid), PlayerName(killerid), reason);
	
	else
	    reportf("%s foi morto (Razão: %d)", REPORT_CALLBACK, PlayerName(playerid));
...
{
    reportf("%s mudou o estado de tecla %d -> %d", REPORT_CALLBACK, PlayerName(playerid), oldkeys, newkeys);
	...
	if(PressedKey(K_SMOKE, newkeys, oldkeys) && GetPlayerSpecialAction(playerid) == SPECIAL_ACTION_SMOKE_CIGGY)
	{
	    if(Cigar[playerid] > 0)
	    {
			...
			xpath = GetPlayerXFilePath(playerid);
			hunger = hGetInt(xpath, "Hunger");
			
			if(hunger < 25)
			    hSetInt(xpath, "Hunger", hunger + 1);
    ...
    if(PressedKey(K_ENTER, newkeys, oldkeys) && Window[playerid][wndOn] == 0)
	{
		...
		if(House[playerid] != -1)
		{
			...
			if(hGetInt(hpath, "Params") & 1 && strcmp(PlayerName(playerid), hGetString(hpath, "Owner"), true) != 0)
			{
			    DrawTextForPlayer(playerid, "Casa trancada.", COLOUR_RED, TEXTDRAW_STYLE_2, 500);
			    return 1;
			}
	    ...
	    if(IsPlayerVehicle(vehid))
     	{
     	    ...
     	    kit = (kit != 2) ? 2 : 3;
     	    hSetInt(vpath, "Params", (params & ~3) | (kit & 3));
...
public OnPlayerStateChange(playerid, newstate, oldstate)
{
	...
	{
	    vehid = GetPlayerVehicleID(playerid);
		reportf("%s mudou de estado: %s -> %s", REPORT_CALLBACK, PlayerName(playerid), GetPlayerStateName(oldstate), GetPlayerStateName(newstate));
	}
		...
		if(IsJobVehicle(vehid, BUS) || IsJobVehicle(vehid, TRAIN))
		{
		    for(new n = 0; n < MAX_SLOTS; n++)
		    {
				if(IsPlayerConnected(n) && IsPlayerLogged(n) && n != playerid)
				{
				    ...
				    {
				        if(GetPlayerSysMoney(playerid) < 25)
				        {
				            SendClientMessage(playerid, COLOUR_WHITE, "Você não possui dinheiro para comprar um Ticket. Custo: $25,00 dólares.");
				            RemovePlayerFromVehicle(playerid);
				        }
				        ...
				        else
				        {
				        	...
				        	SendClientMessage(playerid, COLOUR_WHITE, "Ticket adquirido por $25,00 dólares.");
...
public OnPlayerCommandText(playerid, cmdtext[])
{
	...
	if(!IsPlayerAdmin(playerid))
	{
		...
		if(!IsPlayerModerator(playerid) && strcmp(cmd, "/r", true) != 0 && strcmp(cmd, "/g", true) != 0 && strcmp(cmd, "/a", true) != 0 && strcmp(cmd, "/c", true) != 0)
		    reportf("%s(%d): %s", REPORT_COMMAND, PlayerName(playerid), playerid, cmdtext);
	}
    ...
    if(strcmp(cmd, "/novidades", true) == 0 || strcmp(cmd, "/news", true) == 0)
	{
	    ...
	    if(n == 1)
	    {
	        SendClientMessage(playerid, COLOUR_GREEN, "Virtual Society RPG - Novidades - Parte I - Empregos:");
	        SendClientMessage(playerid, COLOUR_LIGHT_OLIVE, "Para arranjar um emprego, você deve ir para a empresa do mesmo e assinar um contrato,");
	        SendClientMessage(playerid, COLOUR_LIGHT_OLIVE, "tendo que permanecer nesse emprego durante um certo tempo para poder trocá-lo.");
	        SendClientMessage(playerid, COLOUR_LIGHT_OLIVE, "Durante seu jogo, irá acumular Level, e irá tendo acesso a outros empregos.");
	        SendClientMessage(playerid, COLOUR_LIGHT_OLIVE, "É proibido burlar o sistema de level, como por exemplo upar com ajuda de amigos, isto");
	        SendClientMessage(playerid, COLOUR_LIGHT_OLIVE, "acarretará em punições graves, como banimento, remoção da conta e/ou reinício da mesma.");
	        SendClientMessage(playerid, COLOUR_LIGHT_OLIVE, "Cada level corresponde a 7 Xpoints.");
	        SendClientMessage(playerid, COLOUR_LIGHT_OLIVE, "Confira os comandos disponíveis em seu emprego, /emprego [lista]");
	        return 1;
	    }

	    if(n == 2)
	    {
	        SendClientMessage(playerid, COLOUR_GREEN, "Virtual Society RPG - Novidades - Parte II - Armas:");
	        SendClientMessage(playerid, COLOUR_LIGHT_OLIVE, "Você apenas poderá carregar 3 armas, uma arma leve, uma arma pesada e uma arma branca.");
	        SendClientMessage(playerid, COLOUR_LIGHT_OLIVE, "Sua arma pesada ficará a mostra para as outras pessoas, portanto não saiá com ela na rua");
	        SendClientMessage(playerid, COLOUR_LIGHT_OLIVE, "se não estiver procurando encrenca.");
	        SendClientMessage(playerid, COLOUR_LIGHT_OLIVE, "Além disso, é necessário obter licensa para armas, ou poderá ser preso.");
	        SendClientMessage(playerid, COLOUR_LIGHT_OLIVE, "As armas leves e armas pesadas possuem limite de munição, ao ser morto você");
	        SendClientMessage(playerid, COLOUR_LIGHT_OLIVE, "irá perder as armas que estiver carregando.");
	        return 1;
	    }

	    if(n == 3)
	    {
	        SendClientMessage(playerid, COLOUR_GREEN, "Virtual Society RPG - Novidades - Parte III - Chat:");
	        SendClientMessage(playerid, COLOUR_LIGHT_OLIVE, "As mensagens digitadas no chat irão ser exibidas apenas para jogadores próximos a você, mas");
	        SendClientMessage(playerid, COLOUR_LIGHT_OLIVE, "você pode usar o chat global (/g [texto]), usar o chat de veículo (/c [texto]) e além");
	        SendClientMessage(playerid, COLOUR_LIGHT_OLIVE, "disso usar o celular (/celular [comando]) para falar com jogadores longe de forma privada e");
	        SendClientMessage(playerid, COLOUR_LIGHT_OLIVE, "além disso poderá enviar mensagens para jogadores que não estiverem conectados.");
	        SendClientMessage(playerid, COLOUR_LIGHT_OLIVE, "Há disponível também walk-talkies (/walktalkie [comando]) para falar com jogadores sintonizados");
            SendClientMessage(playerid, COLOUR_LIGHT_OLIVE, "na mesma frequência em um determinado raio (para adquirir celular e walk-talkie vá para a 24/7).");
			SendClientMessage(playerid, COLOUR_LIGHT_OLIVE, "Caso queira contatar a administração, use o chat de administrador (/a [texto]), mas use apenas");
            SendClientMessage(playerid, COLOUR_LIGHT_OLIVE, "em casos necessários, como reportar problemas ou pedir ajuda.");
			return 1;
	    }

	    if(n == 4)
	    {
	        SendClientMessage(playerid, COLOUR_GREEN, "Virtual Society RPG - Novidades - Parte IV - Empresas:");
	        SendClientMessage(playerid, COLOUR_LIGHT_OLIVE, "Você também poderá adquirir empresas, contratar funcionários, definir salário, recompensas, contratar");
	        SendClientMessage(playerid, COLOUR_LIGHT_OLIVE, "sócios, definir suas porcentagens, investir nelas ou também trabalhar em uma, pedindo para ser contratado.");
            SendClientMessage(playerid, COLOUR_LIGHT_OLIVE, "Para adquirir uma empresa vá até ela, confira o valor e use /empresa [comprar]");
            SendClientMessage(playerid, COLOUR_LIGHT_OLIVE, "Você poderá apenas contratar funcionários do mesmo ramo da empresa.");
            SendClientMessage(playerid, COLOUR_LIGHT_OLIVE, "Os resultados (lucro, prejuízo) saem uma vez por semana, fique atento!");
			return 1;
	    }

	    if(n == 5)
	    {
	        SendClientMessage(playerid, COLOUR_GREEN, "Virtual Society RPG - Novidades - Parte V - Gangues:");
	        SendClientMessage(playerid, COLOUR_LIGHT_OLIVE, "A disputa por territórios é grande, caso queira participar, crie sua própria gangue e ataque");
	        SendClientMessage(playerid, COLOUR_LIGHT_OLIVE, "outros territórios (/gangue [comandos]), chame pessoas para sua gangue, defina seus cargos,");
	        SendClientMessage(playerid, COLOUR_LIGHT_OLIVE, "você poderá conquistar um território após criar a gangue, os outros terá que conseguir atacando");
         	SendClientMessage(playerid, COLOUR_LIGHT_OLIVE, "os de outras gangues, lembrando: a polícia poderá interferir e tirar todas as gangues deles.");
			return 1;
	    }

	    if(n == 6)
	    {
	        SendClientMessage(playerid, COLOUR_GREEN, "Virtual Society RPG - Novidades - Parte VI - Veículos:");
	        SendClientMessage(playerid, COLOUR_LIGHT_OLIVE, "Adquira seu veículo e deixe-o do jeito que você o quer, aqui você poderá pintá-lo e modificá-lo.");
	        SendClientMessage(playerid, COLOUR_LIGHT_OLIVE, "Claro, você não vai querer ele na mão de estranhos, por isso instale travas.");
	        SendClientMessage(playerid, COLOUR_LIGHT_OLIVE, "Você pode definir aonde quer que ele fique, use /veiculo [estacionar]");
	        SendClientMessage(playerid, COLOUR_LIGHT_OLIVE, "Não esqueça das licensas, vá até as auto-escolas para realizar os testes de habilitação e adquiri-las.");
         	SendClientMessage(playerid, COLOUR_LIGHT_OLIVE, "Para adquirir veículos vá nas concessionárias, há uma para cada tipo (terrestre, aéreo e náutico)");
         	SendClientMessage(playerid, COLOUR_LIGHT_OLIVE, "escolha seu veículo, chegue perto e digite /veiculo [comprar]");
			return 1;
	    }

	    if(n == 7)
	    {
	        SendClientMessage(playerid, COLOUR_GREEN, "Virtual Society RPG - Novidades - Parte VII - Imóveis:");
	        SendClientMessage(playerid, COLOUR_LIGHT_OLIVE, "Compre a casa dos seus sonhos, com o interior que você sempre quis, para isso você deverá");
	        SendClientMessage(playerid, COLOUR_LIGHT_OLIVE, "achá-la à venda, é claro, e em seguida usar /casa [comprar]");
	        SendClientMessage(playerid, COLOUR_LIGHT_OLIVE, "Você poderá ver o que está havendo próximo a sua casa sem sair dela (/janela)");
         	SendClientMessage(playerid, COLOUR_LIGHT_OLIVE, "Além disso, poderá alugar para outra pessoa, e ganhar por isso.");
         	SendClientMessage(playerid, COLOUR_LIGHT_OLIVE, "Para usar os comandos relacionados à casa use: /casa [comando]");
			return 1;
	    }
	    
	    if(n == 8)
	    {
	        SendClientMessage(playerid, COLOUR_GREEN, "Virtual Society RPG - Novidades - Parte VIII - Submissões:");
	        SendClientMessage(playerid, COLOUR_LIGHT_OLIVE, "As submissões são trabalhos/bicos que você pode fazer para ganhar um dinheirinho extra,");
	        SendClientMessage(playerid, COLOUR_LIGHT_OLIVE, "apesar de não ganhar experiência e ganhar menos dinheiro do que sua profissão, é sempre");
	        SendClientMessage(playerid, COLOUR_LIGHT_OLIVE, "bom dar uma variada, não é? Como por exemplo ser DJ da discoteca, entregar sorvetes (Hummmm!)...");
         	SendClientMessage(playerid, COLOUR_LIGHT_OLIVE, "Para iniciar uma submissão, vá até o local da mesma e digite /submissao");
         	SendClientMessage(playerid, COLOUR_LIGHT_OLIVE, "Veja as submissões disponíveis com /submissoes");
			return 1;
	    }
	    
	    if(n == 9)
	    {
	        SendClientMessage(playerid, COLOUR_GREEN, "Virtual Society RPG - Novidades - Parte IV - Acessórios:");
	        SendClientMessage(playerid, COLOUR_LIGHT_OLIVE, "Que tal criar o seu próprio estilo? Colocar um óculos maneiro no rosto, uma guitarra nas costas \\m/,");
            SendClientMessage(playerid, COLOUR_LIGHT_OLIVE, "usar um boné, cata-ovo, uma cabeça de fantasia de galinha (ok, talvez seja exagero)...");
            SendClientMessage(playerid, COLOUR_LIGHT_OLIVE, "Aqui você pode! Basta ir à uma loja de roupas e digite /acessorios [tipo] , os tipos são: oculos,");
            SendClientMessage(playerid, COLOUR_LIGHT_OLIVE, "guitarras e chapeus, caso não fique bem, você poderá vender na loja (/acessorio [vender]) e ser");
            SendClientMessage(playerid, COLOUR_LIGHT_OLIVE, "totalmente reembolsado (avisando desde já que nem todos os acessórios podem funcionar corretamente, irá");
            SendClientMessage(playerid, COLOUR_LIGHT_OLIVE, "depender da skin/roupa que estiver usando). Você ainda poderá esconder/mostrar (/acessorio [esconder/usar])");
            SendClientMessage(playerid, COLOUR_LIGHT_OLIVE, "e remover (/acessorio [remover] , não será reembolsado, mas não precisará estar na loja de roupas).");
			return 1;
	    }

	    SendClientMessage(playerid, COLOUR_GREEN, "Virtual Society RPG - Novidades:");
	    SendClientMessage(playerid, COLOUR_LIGHT_OLIVE, "Seja bem-vindo ao Virtual Society RPG Server, um servidor com várias novidades com");
	    SendClientMessage(playerid, COLOUR_LIGHT_OLIVE, "objetivo de proporcionar diversão à vários jogadores, confira algumas dessas novidades");
	    SendClientMessage(playerid, COLOUR_LIGHT_OLIVE, "pelo servidor ou digite /novidades [lista]");
	    SendClientMessage(playerid, COLOUR_LIGHT_OLIVE, "Esperamos que divirta-se e jogue limpo, sem uso de cheats, hacks e/ou coisas do gênero.");
	    return 1;
	}
	...
	if(strcmp(cmd, "/status", true) == 0)
	{
		...
		if(strlen(category) > 0)
		{
		    ...
		    {
				new drunk[64], drug[64], hunger[64];
				new dcounter, phunger;
				
				dcounter = GetPlayerCounter(playerid, COUNTER_DRUG);
				phunger = hGetInt(xpath, "Hunger");
                ...
                SendClientMessage(playerid, COLOUR_WHITE, string);
                format(string, sizeof string, "Nível de Fome: %s", hunger);
                SendClientMessage(playerid, COLOUR_WHITE, string);
				return 1;
		    }
            ...
            else if(strcmp(category, "profissional", true) == 0)
		    {
		        ...
		        new company, post, reward, payday, jobid, start, end, counter, jobcounter, levelcounter, paycounter;
		        
		        jobid = hGetInt(xpath, "Job");
		        start = JOBSTART(Jobs[jobid][jobTime]);
 	        	end = JOBEND(Jobs[jobid][jobTime]);
		        jobcounter = GetPlayerCounter(playerid, COUNTER_JOB);
				levelcounter = GetPlayerCounter(playerid, COUNTER_LEVEL);
				paycounter = GetPlayerCounter(playerid, COUNTER_PAY);
		        GetPlayerCompanyData(playerid, company, post, reward, payday);
                ...
                SendClientMessage(playerid, COLOUR_WHITE, string);
                format(string, sizeof string, "Salário: $%d,00 dólares (%d/180mins) <> Recompensa: %s", payday, paycounter, rwd);
                SendClientMessage(playerid, COLOUR_WHITE, string);
                format(string, sizeof string, "Horário: %s%d:00 até %s%d:00 (Segunda à Sábado)", (start < 10) ? ("0") : (""), start, (end < 10) ? ("0") : (""), end);
	       		SendClientMessage(playerid, COLOUR_WHITE, string);
		    ...
		    {
		        new vpath[128], hpath[128], house[64], modeltype[32], name[MAX_PLAYER_NAME];
				new vehicles[MAX_VEHICLES_PER_PLAYER];
		        new vcounter, hcounter, houseid, itens, model;
		        ...
		        for(new h = 0; h < GetHouses(); h++)
				{
					...
					if(strlen(hpath) > 0 && hGetInt(hpath, "Deleted") == 0 && strcmp(name, hGetString(hpath, "Owner"), true) == 0)
				        hcounter++;
				}
				...
				for(new v = 0; v < vcounter; v++)
				{
				    if(v >= sizeof vehicles)
						break;
						
				    vpath = GetVehicleFilePath(vehicles[v]);
				    
				    if(strlen(vpath) > 0)
				    {
				        model 		= 	hGetInt(vpath, "Model");
				        modeltype 	= 	IsBikeModel(model) ? ("Moto/Bicicleta") :
				                    	IsAirModel(model) ? ("Avião/Helicóptero") :
				                    	IsBoatModel(model) ? ("Barco") :
				                    	("Carro");
				                    
				        format(string, sizeof string, "Veículo %d (%s) -> Modelo: %s <> Placa: %s", v + 1, modeltype, Vehicles[model - 400][vehModel], hGetString(vpath, "NumberPlate"));
				        SendClientMessage(playerid, COLOUR_WHITE, string);
				    }
				}
    ...
    if(strcmp(cmd, "/celular", true) == 0)
	{
	    ...
	    if(strlen(phone_cmd) > 0)
	    {
	        ...
	        else if(strcmp(phone_cmd, "saldo", true) == 0)
	        {
	            if(GetPlayerSysMoney(playerid) < 20)
	            {
	                SendClientMessage(playerid, COLOUR_GRAY, "Você não possui dinheiro. Custo: $20,00 dólares.");
	                return 1;
	            }
	            
	            GivePlayerSysMoney(playerid, -20);
	            SendClientMessage(playerid, COLOUR_WHITE, "[ Mensagem enviada por $20,00 dólares, aguarde resposta... ]");
	            SetTimerEx("ShowBalance", 2000, false, "d", playerid);
	            return 1;
	        }
	    }
	    ...
	    SendClientMessage(playerid, COLOUR_GRAY, "ver, excluir, info, saldo");
	    return 1;
	}
	...
	if(strcmp(cmd, "/casa", true) == 0)
	{
	    ...
	    if(strlen(house_cmd) > 0)
	    {
			...
			{
			    new xpath[128], string[128], owner[128], rent[128];
				new value, onsale;
				...
				if(onsale == 1)
				{
				    ...
				    format(string, sizeof string, "[ Sua casa N°%d foi comprada por %s (Banco +$%d,00 dólares) ]", houseid + 1, PlayerName(playerid), value);
			...
			else if(strcmp(house_cmd, "despejar", true) == 0)
			{
				...
				if(!strlen(rent))
				{
				    SendClientMessage(playerid, COLOUR_GRAY, "Você não alugou essa casa para nenhum jogador.");
				    return 1;
				}
			...
			else if(strcmp(house_cmd, "trancar", true) == 0)
			{
			    new params, locked;
				...
				params = hGetInt(hpath, "Params");
				locked = !(params & 1);
				hSetInt(hpath, "Params", (params & ~1) | (locked & 1));
				
				if(locked)
					SendClientMessage(playerid, COLOUR_ROYAL_BLUE, "Casa trancada.");
					
				else
				    SendClientMessage(playerid, COLOUR_ROYAL_BLUE, "Casa destrancada.");
	    ...
	    SendClientMessage(playerid, COLOUR_GRAY, "comprar, vender, alugar, despejar, nascer, trancar");
	    return 1;
	}
	...
	if(strcmp(cmd, "/empresa", true) == 0)
	{
	    ...
	    if(strlen(com_cmd) > 0)
	    {
	        if(strcmp(com_cmd, "comprar", true) == 0)
			{
				...
				if(GetPlayerCompanies(playerid) >= MAX_COMPANIES_PER_PLAYER)
				{
				    new string[128];
					format(string, sizeof string, "Você ultrapassou a quantidade máxima de empresas (Máximo: %d)", MAX_COMPANIES_PER_PLAYER);
					SendClientMessage(playerid, COLOUR_GRAY, string);
					return 1;
				}
			...
			else if(strcmp(com_cmd, "porcentagem", true) == 0)
			{
				...
				if(strcmp(PlayerName(playerid), hGetString(cpath, "Owner"), true) != 0)
				{
	    			SendClientMessage(playerid, COLOUR_GRAY, "Você não é o dono dessa empresa.");
	   				return 1;
				}
	...
	if(strcmp(cmd, "/veiculo", true) == 0)
	{
	    ...
	    if(strlen(vehicle_cmd) > 0)
	    {
			if(strcmp(vehicle_cmd, "comprar", true) == 0)
			{
				...
				if(GetPlayerVehicles(playerid) >= MAX_VEHICLES_PER_PLAYER)
				{
				    new string[128];
					format(string, sizeof string, "Você ultrapassou o limite de carros por jogador (Máximo: %d)", MAX_VEHICLES_PER_PLAYER);
					SendClientMessage(playerid, COLOUR_GRAY, string);
					return 1;
				}
	    ...
	    SendClientMessage(playerid, COLOUR_GRAY, "comprar, vender, desmanchar, estacionar");
	    return 1;
	}
	...
	if(strcmp(cmd, "/oficina", true) == 0)
	{
	    ...
	    if(strlen(workshop_cmd) > 0)
	    {
		    ...
		    else if(strcmp(workshop_cmd, "instalar", true) == 0)
	    	{
				...
				if(!IsPlayerAdmin(playerid))
		        {
		            if(strcmp(hGetString(vpath, "Owner"), PlayerName(playerid), true) != 0)
		            {
		                SendClientMessage(playerid, COLOUR_GRAY, "Você não pode instalar itens em um veículo de outro jogador.");
		            	return 1;
		            }
		        }
				...
				if(strlen(item) > 0)
				{
		    		if(strcmp(item, "kit", true) == 0)
		    		{
                        ...
                        GivePlayerSysMoney(playerid, -500);
     			    	...
     			    	SendClientMessage(playerid, COLOUR_WHITE, "Travas instaladas.");
     	    			return 1;
		    		}
				    ...
				    if(strcmp(item, "fume", true) == 0)
				    {
                        ...
                        if(GetPlayerSysMoney(playerid) < 800)
		        		{
		            		SendClientMessage(playerid, COLOUR_GRAY, "Você não possui dinheiro. Custo: $800,00 dólares.");
		            		return 1;
		        		}
		        		
		        		GivePlayerSysMoney(playerid, -800);
				        hSetInt(vpath, "Params", params | 4);
				        SendClientMessage(playerid, COLOUR_WHITE, "Vidro Fumê instalado.");
						return 1;
		    		}
		    		...
		    		if(strcmp(item, "airbag", true) == 0)
		    		{
				        ...
				        SendClientMessage(playerid, COLOUR_WHITE, "Airbags instalados.");
						return 1;
		    		}
				}

				SendClientMessage(playerid, COLOUR_GRAY, "USO: /oficina instalar [item] - ITENS DISPONÍVEIS:");
	    ...
	    SendClientMessage(playerid, COLOUR_GRAY, "consertar, pintar, instalar");
	    return 1;
	}
	...
	if(strcmp(cmd, "/assinar", true) == 0)
	{
		...
		SendClientMessage(playerid, COLOUR_GREEN, "Contrato assinado! Você só poderá mudar de profissão novamente após 60 minutos (1h na realidade).");
		return 1;
	}
	...
	if(strcmp(cmd, "/submissao", true) == 0)
	{
		...
		switch(submission)
		{
		    case SUBMISSION_ICE_CREAM:
		    {
		        ...
		        {
		            SendClientMessage(playerid, COLOUR_GRAY, "Você só pode entregar sorvetes das 12:00 às 20:00");
		            return 1;
		        }
		    ...
		    case SUBMISSION_DRUGS:
		    {
		        ...
		        {
		            SendClientMessage(playerid, COLOUR_GRAY, "Você só pode entregar drogas das 22:00 às 06:00");
		            return 1;
		        }
		    ...
		    case SUBMISSION_IML:
		    {
		        if(CurrentHour > 6 && CurrentHour < 22)
		        {
		            SendClientMessage(playerid, COLOUR_GRAY, "Você só pode transportar corpos das 22:00 às 06:00");
		            return 1;
		        }
			...
			case SUBMISSION_CEMENT:
			{
			    if(CurrentHour < 12 || CurrentHour > 20)
		        {
		            SendClientMessage(playerid, COLOUR_GRAY, "Você só pode descarregar cimento das 12:00 às 20:00");
		            return 1;
		        }
			...
			{
			    if(CurrentHour > 3 && CurrentHour < 19)
		        {
		            SendClientMessage(playerid, COLOUR_GRAY, "Você só pode consertar postes das 19:00 às 03:00");
		            return 1;
		        }
	...
	if(strcmp(cmd, "/pagardividas", true) == 0)
	{
		...
		if(option == 2)
		{
		    ...
		    vehid = GetPlatePlayerVehicleId(plate);
	...
	if(strcmp(cmd, "/transferir", true) == 0)
	{
		...
		SendClientMessage(plid, COLOUR_WHITE, string);
		reportf("%s(%d) transferiu $%d,00 dólares à %s(%d)", REPORT_PAY, PlayerName(playerid), playerid, value, PlayerName(plid), plid);
		return 1;
	}
	if(strcmp(cmd, "/pagar", true) == 0)
	{
		...
		SendClientMessage(plid, COLOUR_WHITE, string);
		reportf("%s(%d) pagou $%d,00 dólares à %s(%d)", REPORT_PAY, PlayerName(playerid), playerid, value, PlayerName(plid), plid);
		return 1;
	}
	...
	if(strcmp(cmd, "/pescar", true) == 0)
	{
        ...
        Fishing[playerid] = 1;
        SendClientMessage(playerid, COLOUR_FISHER, "Você lançou a rede de pesca. Espere ela voltar para concluir a pesca.");
		SendClientMessage(playerid, COLOUR_FISHER, "Enquanto ela não vem, fique apreciando a paisagem.");
	...
	if(strcmp(cmd, "/iscas", true) == 0)
	{
		...
		{
	   		SendClientMessage(playerid, COLOUR_GRAY, "USO: /iscas [quantidade] - Quantidade de 1 à 20.");
  			return 1;
		}
	...
	if(strcmp(cmd, "/pizza", true) == 0)
	{
		...
		if(strlen(pizza_cmd) > 0)
		{
		    if(strcmp(pizza_cmd, "vender", true) == 0)
		    {
				...
				hSetInt(GetPlayerXFilePath(plid), "Hunger", 0);
	...
	if(strcmp(cmd, "/apreenderveiculo", true) == 0)
	{
		...
		SaveVehiclePos(vehid, X, Y, Z, A);
        RemovePlayerFromVehicle(playerid);
        DrawTextForPlayer(playerid, "Veículo apreendido.~n~$200,00 dólares", COLOUR_GREEN, TEXTDRAW_STYLE_2, 3000);
	    return 1;
	}
	...
	if(strcmp(cmd, "/r", true) == 0)
	{
		...
		if(IsPlayerInAnyVehicle(playerid) || IsPlayerCop(playerid))
		{
		    if(IsPlayerCop(playerid))
		    {
				model = 1;
	...
	if(strcmp(cmd, "/g", true) == 0)
	{
		...
		GChat[playerid] += 25;
		format(msg, sizeof msg, ">>> ( %s(%d): %s ) <<<", PlayerName(playerid), playerid, msg);
	...
	if(strcmp(cmd, "/c", true) == 0)
	{
		...
		vehid = GetPlayerVehicleID(playerid);
		format(msg, sizeof msg, "[VEICULO CHAT] %s(%d): %s", PlayerName(playerid), playerid, msg);
	...
	{
		new msg[256], adm_msg[256], mod_msg[256];
		new colour;
		...
		if(IsPlayerAdmin(playerid))
		{
		    format(adm_msg, sizeof adm_msg, "[ADMIN CHAT] %s(%d): %s", PlayerName(playerid), playerid, msg);
		    colour = COLOUR_ADMIN;
		}
		
		else if(IsPlayerModerator(playerid))
		{
		    format(adm_msg, sizeof adm_msg, "[MODERATOR CHAT] %s(%d): %s", PlayerName(playerid), playerid, msg);
		    format(mod_msg, sizeof mod_msg, "[MODERATOR CHAT] %s(%d): %s", PlayerName(playerid), playerid, msg);
		    colour = COLOUR_MODERATOR;
		}
		
		else
		{
		    format(adm_msg, sizeof adm_msg, "[ADMIN HELP] %s(%d): %s", PlayerName(playerid), playerid, msg);
		    format(mod_msg, sizeof mod_msg, "[MODERATOR HELP] %s(%d): %s", PlayerName(playerid), playerid, msg);
		    colour = COLOUR_GOLD;

			SendClientMessage(playerid, colour, adm_msg);
		}
		...
		for(new n = 0; n < MAX_SLOTS; n++)
		{
		    if(IsPlayerConnected(n) && IsPlayerLogged(n))
			{
			    if(strlen(adm_msg) > 0 && IsPlayerAdmin(n))
		        	SendClientMessage(n, colour, adm_msg);
		        	
				else if(strlen(mod_msg) > 0 && IsPlayerModerator(n))
				    SendClientMessage(n, colour, mod_msg);
		    }
		}
		
		report(adm_msg, REPORT_CHAT);
		return 1;
	}
	...
	if(strcmp(cmd, "/moderador", true) == 0)
	{
        ...
        if(strcmp(mod_cmd, "say", true) == 0)
	    {
			...
			new msg[128];
	        format(msg, sizeof msg, "* (Moderador) %s(%d): %s", PlayerName(playerid), playerid, mod_tmp);
        ...
        else if(strcmp(mod_cmd, "pm", true) == 0)
	    {
			...
			new msg[128];
	        format(msg, sizeof msg, "* PM (Moderador) %s(%d): %s", PlayerName(playerid), playerid, mod_tmp);
	        SendClientMessage(plid, COLOUR_MODERATOR, msg);
	        format(msg, sizeof msg, "* PM (Moderador) para %s(%d): %s", PlayerName(plid), playerid, mod_tmp);
		...
		reportf("Moderator Command: %s(%d) -> %s", REPORT_DEFAULT, PlayerName(playerid), playerid, cmdtext);
	...
	if(strcmp(cmd, "/admin", true) == 0)
	{
		...
		if(strcmp(adm_cmd, "say", true) == 0)
	    {
			...
			new msg[128];
	        format(msg, sizeof msg, "* (Admin) %s(%d): %s", PlayerName(playerid), playerid, adm_tmp);
	    ...
	    else if(strcmp(adm_cmd, "pm", true) == 0)
	    {
			...
			new msg[128];
	        format(msg, sizeof msg, "* PM (Admin) %s(%d): %s", PlayerName(playerid), playerid, adm_tmp);
	        SendClientMessage(plid, COLOUR_ADMIN, msg);
	        format(msg, sizeof msg, "* PM (Admin) para %s(%d): %s", PlayerName(plid), plid, adm_tmp);
	    ...
	    else if(strcmp(adm_cmd, "colete", true) == 0)
	    {
	        ...
	        SetPlayerSysArmour(plid, floatstr(adm_tmp));
	    }
	    ...
	    else if(strcmp(adm_cmd, "vapagar", true) == 0)
	    {
	        if(IsPlayerInAnyVehicle(playerid))
	        {
	            new vehid;
	    ...
	    else
	    {
			...
			SendClientMessage(playerid, COLOUR_GRAY, "power, spawnar, vspawnar, vapagar, goto, anunciar, casa, vercasa, valorizarcasa, apagarcasa, server,");
		...
		reportf("Admin Command: %s(%d) -> %s", REPORT_DEFAULT, PlayerName(playerid), playerid, cmdtext);
	    SendClientMessage(playerid, COLOUR_GREEN, "Feito.");
	    return 1;
	}
	...
	for(new n = 0; n < MAX_SLOTS; n++)
	{
	    if(IsPlayerConnected(n) && IsPlayerLogged(n) && Dying[n] == 0)
	    {
            ...
            else
            {
                ...
                {
                    if(pReport[n][REPORT_HEALTH] <= 0)
                    {
                        pReport[n][REPORT_HEALTH] = TREPORT;
                    	reportf("%s(%d) - Vida +%.2f", REPORT_ACTION, PlayerName(n), n, health - pHealth[n]);
					}
                ...
                if(floatcmp(armour, pArmour[n]) > 0)
                {
                    ...
                    {
                        pReport[n][REPORT_HEALTH] = TREPORT;
                    	reportf("%s(%d) - Colete +%.2f", REPORT_ACTION, PlayerName(n), n, armour - pArmour[n]);
					}
            ...
            else
            {
    			...
    			if(pMoney[n] != money)
    			{
    			    if(pReport[n][REPORT_MONEY] <= 0)
                    {
						...
						if(sub > 0)
    		    			reportf("%s(%d) - Dinheiro +$%d,00", REPORT_ACTION, PlayerName(n), n, sub);
    		    	
						else
						    reportf("%s(%d) - Dinheiro -$%d,00", REPORT_ACTION, PlayerName(n), n, -sub);
						    
                        pReport[n][REPORT_MONEY] = TREPORT;
					}
            ...
            else
            {
	            ...
	            if(weaponid != 0)
	            {
					...
					{
					    if(pReport[n][REPORT_WEAPONS] <= 0)
					    {
					        pReport[n][REPORT_WEAPONS] = TREPORT;
					    	reportf("%s(%d) - Arma +%d/%d", REPORT_ACTION, PlayerName(n), n, weaponid, ammo);
						}
					...
					else if(pWeapons[n][0] == weaponid)
					{
					    if(pWeapons[n][1] < ammo)
					    {
					    	...
					    	{
					    	    pReport[n][REPORT_WEAPONS] = TREPORT;
					    	    reportf("%s(%d) - Arma +%d/%d", REPORT_ACTION, PlayerName(n), n, weaponid, ammo - pWeapons[n][1]);
							}
					...
					else if(pWeapons[n][2] == weaponid)
					{
					    if(pWeapons[n][3] < ammo)
					    {
					    	...
					    	{
					    	    pReport[n][REPORT_WEAPONS] = TREPORT;
					        	reportf("%s(%d) - Arma +%d/%d", REPORT_ACTION, PlayerName(n), n, weaponid, ammo - pWeapons[n][3]);
							}
...
{
    if(strlen(Ints[int][intName]) > 0)
		reportf("%s entrou no(a) %s [Entrada: %d]", Ints[int][intName], enter);
...
{
	if(strlen(Ints[int][intName]) > 0)
    	reportf("%s saiu do(a) %s [Entrada: %d]", Ints[int][intName], enter);
...
stock HTTPRequest(playerid, request)
{
	...
	HTTP(HTTP_REQUEST, HTTP_POST, "www.virtualsocietyrpg.com/UCP/admin/internal.php", data, "HTTPResponse");
...
public HTTPResponse(index, response_code, data[])
{
    ...
    new code = strval(data);

	if((code < 0 || code == 1) && (strlen(data) == 2))
	{
		switch(code)
		{
	    	case 1, -6:
			...
			case UCP_CANT_CONNECT:
				report("Erro ao conectar ao FTP/MySQL.", REPORT_UCP);
...
stock UCPAction(data[])
{
	...
	while(strlen(result))
	{
		...
		switch(action)
		{
		    case UCP_KICK:
		    {
		        format(message, 64, "[UCP] %s foi kickado.", PlayerName(plid));
			...
			case UCP_BAN:
			{
				...
				reason = strtok(result, start, '§');
			
			    format(message, 128, "[UCP] %s foi banido, motivo - %s.", PlayerName(plid), result[start]);
		     	SendClientMessageToAll(-1, message);
			...
			case UCP_MESSAGE:
			{
				...
				user = strtok(result, start, '§');
				toUser = strval(strtok(result, start, '§'));

				if(toUser == -1)
				{
				    format(message, 128, "[UCP] %s - %s", user, result[start]);
				    SendClientMessageToAll(-1, message);
				}
				else
				{
				    ...
				    format(message, 128, "[UCP] PM de %s - %s", user, toUser, result[start]);
				    SendClientMessage(toUser, -1, message);
				}
			}
		}
...
public OnPlayerTakeDamage(playerid, issuerid, Float:amount, weaponid)
{
	if(issuerid != INVALID_PLAYER_ID)
	    reportf("%s levou dano (%.2f) de %s [Arma: %d]", REPORT_CALLBACK, PlayerName(playerid), amount, PlayerName(issuerid), weaponid);
	
	else
    	reportf("%s levou dano (%.2f)", REPORT_CALLBACK, PlayerName(playerid), amount);
    
	GetPlayerHealth(playerid, pHealth[playerid]);
	GetPlayerArmour(playerid, pArmour[playerid]);

	if(floatcmp(pArmour[playerid], 0.0) > 0)
	{
		...
		{
		    if(pReport[playerid][REPORT_HEALTH] <= 0)
			{
			    pReport[playerid][REPORT_HEALTH] = TREPORT;
            	reportf("%s(%d) - Colete +%.2f", REPORT_ACTION, PlayerName(playerid), playerid, (pArmour[playerid] + amount) - 100);
			}
	...
	else
	{
		...
		if(floatcmp(pHealth[playerid] + amount, 100.0) > 0)
		{
			...
			{
			    pReport[playerid][REPORT_HEALTH] = TREPORT;
    	    	reportf("%s(%d) - Vida +%.2f", REPORT_ACTION, PlayerName(playerid), playerid, (pHealth[playerid] + amount) - 100);
			}
 	...
 	if(dialogid == DIALOG_INVITE)
 	{
 	    ...
 	    if(response)
 	    {
			...
			else if(Invite[playerid] == INVITE_CHOP)
			{
			    ...
			    vehid = InviteParams[playerid] & 0xFFFF;
			    value = (InviteParams[playerid] >> 16) & 0xFFFF;
...
public Speedometer()
{
    for(new n = 0; n < MAX_SLOTS; n++)
	{
	    if(IsPlayerConnected(n) && IsPlayerLogged(n) && IsPlayerInAnyVehicle(n) && GetPlayerState(n) == PLAYER_STATE_DRIVER)
	    {
			...
			GetVehicleVelocity(vehid, VP[0], VP[1], VP[2]);
			GetVehicleHealth(vehid, H);
			V = floatsqroot((VP[0] * VP[0]) + (VP[1] * VP[1]) + (VP[2] * VP[2])) * 161.0;
...
public BusStop(playerid)
{
	...
	if(terminal == -1)
	{
	    ...
	    Pay(playerid, 300);
	    DrawTextForPlayer(playerid, "Rota concluída, você recebeu $300,00 dólares.", COLOUR_MACHINIST, TEXTDRAW_STYLE_2, 5000);
	}
        		...
        		for(new c = 1; c < sizeof Companies; c++)
        		{
    	    	    if(GetDistance(X, Y, Z, Companies[c][cX], Companies[c][cY], Companies[c][cZ]) <= 10.0)
	        	    {
	        	        ...
	        	        OPT[3] = (Jobs[jobid][jobHabA] == 1) ? ("Sim") : ("Não");
	       		        ...
	       		        format(string, sizeof string, "[INFORMACOES] Emprego: %s - Salário: $%d,00 dólares - Público: %s - Tempo de contrato: 60 minutos (1h real)", Jobs[jobid][jobName], Jobs[jobid][jobPayday], OPT[0]);
	       		        SendClientMessage(n, COLOUR_WHITE, string);
	       		        format(string, sizeof string, "[INFORMACOES] Horário: %s%d:00 até %s%d:00 (Segunda à Sábado)", (start < 10) ? ("0") : (""), start, (end < 10) ? ("0") : (""), end);
	       		        SendClientMessage(n, COLOUR_WHITE, string);
...
{
    reportf("Veículo %d spawnou", REPORT_CALLBACK, vehicleid);
...
{
	if(killerid != INVALID_PLAYER_ID)
    	reportf("Veículo %d destruido por %s", REPORT_CALLBACK, vehicleid, PlayerName(killerid));
    
    else
        reportf("Veículo %d destruido", REPORT_CALLBACK, vehicleid);
...
{
	reportf("Veículo %d processado para o jogador %s", REPORT_CALLBACK, vehicleid, PlayerName(forplayerid));
	...
	if(!IsPlayerAdmin(forplayerid))
	{
	    ...
	    else
	    {
			...
			if( (IsJobVehicle(vehicleid, REEFER) 			&& 		jobid != JOB_FISHER) ||
				(IsJobVehicle(vehicleid, TAXI) 				&& 		jobid != JOB_CABBIE) ||
...
{
	reportf("Veículo %d modificado com componente %d por %s", REPORT_CALLBACK, vehicleid, componentid, PlayerName(playerid));
	...
	for(new n = 0; n < MAX_SLOTS; n++)
	{
	    if(IsPlayerConnected(n) && IsPlayerLogged(n))
	    {
	        ...
	        if(Audience[0] != n && Audience[1] != n && btime > 0)
	        {
				...
				{
					format(string, sizeof string, "Mais um minuto se passou... Tempo restante: %dmins", btime);
					SendClientMessage(n, COLOUR_WHITE, string);
				}
			}
...
public ServerWarning()
{
	...
	{
	    warno = random(3);
	    SendClientMessageToAll(COLOUR_WHITE, "----------------------------------------------------------------------------------------------------");

		if(warno == 0)
	        SendClientMessageToAll(COLOUR_PINK, "Virtual Society RPG, crescendo humildemente a cada dia. ;D");
	        
	//	if(warno == 2)
	//		SendClientMessageToAll(COLOUR_BLUE, "Virtual Society RPG, {FF0000}um {00FF00}servidor {FFFFFF}com {FFFF00}mensagens {FF00FF}c{A020F0}o{FFFFFF}l{00FF00}o{FFFF00}r{FF0000}i{FF4500}d{FFD700}a{FFFFFF}s{0000FF}... ^^");

		if(warno == 1 || warno == 2)
		    SendClientMessageToAll(COLOUR_LIGHT_OLIVE, "Virtual Society RPG, mais que um RPG, UMA VIDA!");
...
public Time()
{
	    ...
	    if(IsPlayerConnected(n) && IsPlayerLogged(n) && IntroductionPart[n] == 0)
	    {
	        ...
	        if(mins == 0)
	        {
				if(hunger < 25)
				{
					...
					{
					    hunger = 25;
					    SendClientMessage(n, COLOUR_LIGHT_YELLOW, "Você está com fome, precisa comer algo, peça uma pizza ou vá comer em algum local, como Restaurante, Bar,");
	            		SendClientMessage(n, COLOUR_LIGHT_YELLOW, "Pizzaria, Cluckin Bell, Burger Shot, World of Coq, Loja de Donuts, etc...");
					}
					
					else if(hunger > 25)
					    SendClientMessage(n, COLOUR_LIGHT_YELLOW, "Rooonnc... Seu estomago já está conversando com você, melhor comer algo.");
					
				    hSetInt(xpath, "Hunger", hunger);
				}
				...
				else
				{
				    ...
				    GetPlayerSysHealth(n, H);
				    
					if(floatcmp(H, 5.0) > 0)
				    	SetPlayerSysHealth(n, H - 5.0);
				}
			...
			if(mins % 5 == 0)
			{
			    if(Limp[n] == 2)
				{
					...
					GetPlayerHealth(n, health);
					SetPlayerSysHealth(n, health - 1.0);
					
					if(health > 0.0 && health < 25.0)
					{
		    			if(!IsPlayerInAnyVehicle(n))
			    			ApplyAnimation(n, "RYDER", "RYD_Die_PT1", 4.1, 1, 1, 1, 1, 1, 1);
					}
					
					else
					{
					    SetPlayerDrunkLevel(n, pDrunk[n]);
						Limp[n] = 0;
						HideTextGray(n);
					}
				}
			...
			SetPlayerScore(n, hGetInt(xpath, "Level"));
	...
	if(mins == 0)
	{
	    if(CurrentTime >= 1440)
	    {
			...
			ResetCTMVehicles();
			SendClientMessageToAll(COLOUR_GREEN, "Dia novo, carros novos, tá esperando o que? Venha na concessionária conferir!");
		}
